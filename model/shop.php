<?php
    ...
    function getAllProductByFilter($where){
        $sql = "select products.idProduct, products.nameProduct, products.idCategory, products.idBrand, products.imgUrl, price, oldPrice, productdetail.idProductDetail from products inner join productdetail on products.idProduct = productdetail.idProduct $where";
        return query($sql);
    }
?>